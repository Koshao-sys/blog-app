...
**Blog App** is an app that is going to basically hanle posts, likes and comments from various users and storing them directly to the database with an impressive technology.
...
- gem install rails
- Clone this repository to your desired folder: https://github.com/Koshao-sys/blog-app.git
...
Feel free to check the [issues page](https://github.com/Koshao-sys/blog-app/issues).
